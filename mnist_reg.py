...
def main():
    ...
    base_outpth = './data'  # '/content/gdrive/My Drive/Colab Notebooks/data/'
    tr_outpth = os.path.join(base_outpth, 'train_stats.csv')
    te_outpth = os.path.join(base_outpth, 'test_stats.csv')

    train_stats = pd.DataFrame(train_ls,
                               columns=['epoch', 'train_example_num', 'num_examples', 'percentage_of_examples', 'loss'])
